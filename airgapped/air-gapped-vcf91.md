...
After regional Harbor is installed and configured successfully, the default add-on package repository (pointing to regional Harbor) is configured and installed automatically. Verify the add-on repository and list the available packages:
